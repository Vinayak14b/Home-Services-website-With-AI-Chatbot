...
<head>
    <meta charset="utf-8">
    <title>QuickHomeCare - Online Service Provider for your House Needs</title>
                    ...
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            ...
                            <li><a href="mailto:contact@surfsidemedia.in"><i class="fa fa-envelope"></i>
                                    contact@quickhomecare@gmail.com</a></li>
                        </ul>
                    ...
                    <div class="row visible-md visible-lg">
                        ...
                        <div class="col-md-3 col-xs-6 col-sm-6">
                            ...
                            <ul class="contact_footer">
                                <li class="location">
                                    <i class="fa fa-map-marker"></i> <a href="#">Pune ,Maharashtra, India</a>
                                </li>
                                <li>
                                    <i class="fa fa-envelope"></i> <a
                                        href="mailto:quickhomecare@gmail.com">contact@quickhomecare@gmail.com</a>
                                </li>
                                <li>
                                    <i class="fa fa-headphones"></i> <a href="tel:+919156781814">+91-9156781814</a>
                                </li>
                            </ul>
                ...
                <div class="footer-down">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p class="text-xs-center crtext">&copy; 2023 Quick-Home Service. All Rights Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>

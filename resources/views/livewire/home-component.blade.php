                        ...
                        <ul id="sponsors" class="tooltip-hover">
                            ...
                            @foreach ($scategories as $scategory)
                                <li data-toggle="tooltip" title="" data-original-title="{{ $scategory->name }}">
                                    <a
                                        href="{{ route('home.services_by_category', ['category_slug' => $scategory->slug]) }}">
        ...
        <div class="content_info">
            <div>
                <div class="container">
                    <div class="row">
                        <div class="titles">
                            <h2>QuickHomeCare<span>Choice</span> of Services</h2>
                                ...
                                <a class="g-list"
                                    ...
                                    <div class="info-gallery">
                                        ...
                                        <div class="content-btn">
                                            <a href="{{ route('home.contact') }}">Book Now</a>
                                        </div>
                        ...
                        <div class="col-md-8">
                            <ul class="services-lines">
                                ...
                                @foreach ($fcategories as $fcategory)
                                    <li>
                                        <a
                                            href="{{ route('home.services_by_category', ['category_slug' => $fcategory->slug]) }}">
                    ...
                    <div>
                        <a class="g-list"
                            ...
                            <div class="info-gallery">
                                ...
                                <div class="content-btn"><a href="{{ route('home.contact') }}">Book Now</a></div>

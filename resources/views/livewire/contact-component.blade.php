                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <aside>
                                <h4>The Office</h4>
                                <address>
                                    <strong>QuickHomeCare Services.</strong><br>
                                    <i class="fa fa-map-marker"></i><strong>Address: </strong>Pune, Maharashtra,
                                    India<br>
                                    <i class="fa fa-phone"></i><strong>Phone: </strong> +91-9156781814
                                </address>
                                <address>
                                    <strong>QuickHomeCare Emails</strong><br>
                                    <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                        href="mailto:contact@quickhomecare@gmail.com">
                                        contact@quickhomecare@gmail.com</a><br>
                                    <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                        href="mailto:support@quickhomecare@gmail.com">
                                        support@quickhomecare@gmail.com</a>
                                </address>
                            </aside>
                            <hr class="tall">
                        </div>
